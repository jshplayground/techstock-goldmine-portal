...
export const ContainerScroll = ({
  ...
  return <div className="h-[40rem] md:h-[60rem] flex items-center justify-center relative p-2 md:p-20" ref={containerRef}>
      <div className="py-10 md:py-20 w-full relative" style={{
      perspective: "1000px"
    }}>
...
export const Header = ({
  ...
  }} className="div max-w-5xl mx-auto text-center py-[30px]">
      {titleComponent}
    </motion.div>;
};
export const Card = ({
